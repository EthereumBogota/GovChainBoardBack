...
export class Contract__proposalVotesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Contract extends ethereum.SmartContract {
  ...
  proposalVotes(proposalId: BigInt): Contract__proposalVotesResult {
    let result = super.call(
      "proposalVotes",
    ...
    return new Contract__proposalVotesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_proposalVotes(
    proposalId: BigInt
  ): ethereum.CallResult<Contract__proposalVotesResult> {
    let result = super.tryCall(
      "proposalVotes",
      "proposalVotes(uint256):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__proposalVotesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
